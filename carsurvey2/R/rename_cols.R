  ...
  tryCatch(
    {
      data <- dplyr::rename(data, 
                            ...
                            knowledge_SAS = "Q10.2",
                            knowledge_VBA = "Q10.3",
                            knowledge_python = "Q10.4",
                            knowledge_SPSS = "Q10.5",
                            knowledge_stata = "Q10.6",
                            knowledge_JS = "Q10.7",
                            knowledge_java = "Q10.8",
                            knowledge_C = "Q10.9",
                            
                            available_R = "Q10.10",
                            available_SQL = "Q10.11",
                            available_SAS = "Q10.12",
                            available_VBA = "Q10.13",
                            available_python = "Q10.14",
                            available_SPSS = "Q10.15",
                            available_stata = "Q10.16",
                            available_JS = "Q10.17",
                            available_java = "Q10.18",
                            available_C = "Q10.19",
                            other_tool = "Q10.20",
