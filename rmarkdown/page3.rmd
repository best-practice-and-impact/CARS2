...
carsurvey2::plot_grouped(components, "RAP component", "Count", orientation = "h")
...
knitr::kable(components, row.names = FALSE)
...
knitr::kable(basic_freqs, row.names = FALSE)
...
knitr::kable(advanced_freqs, row.names = FALSE)
