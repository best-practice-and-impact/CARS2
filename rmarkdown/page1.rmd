...
carsurvey2::plot_stacked(knowledge, xlab = "Count", ylab = "Programming tool", colour_scale = "scale", font_size = 14)
...
carsurvey2::plot_stacked(access, xlab = "Count", ylab = "Programming tool", colour_scale = "scale". font_size = 14)
...
carsurvey2::plot_stadfcked(code_tool_status, colour_scale = "scale", xlab = "Count", ylab = "Programming tool", font_size = 14)
...
carsurvey2::plot_likert(rap_opinions_chart, 3, "Frequency", "Question", font_size = 14, height = 700)
...
carsurvey2::plot_likert(code_prac_chart, 3, "Frequency", "Question", neutral_mid = FALSE, font_size = 14, height = 700)
...
carsurvey2::plot_likert(doc_chart, 3, "Frequency", "Question", neutral_mid = FALSE, font_size = 14, height = 700)
