...
plot <- carsurvey2::plot_freqs(freqs_plot, "", "Sample size", n = sum(freqs_plot$`Sample size`), font_size = 14, orientation = "h", height = 400)
...
urls <- gsub(" \\(or equivalent\\)", "", alphabetical)
urls <- gsub(" ", "-", urls)
urls <- gsub(",", "", urls)
