...
dep_freqs <- data.frame(table(smart_survey_data$dept))
...
carsurvey2::plot_freqs(dep_freqs_plot, "", "Sample size", n = sum(dep_freqs_plot$`Sample size`), font_size = 14, orientation = "h", height = 1000)
