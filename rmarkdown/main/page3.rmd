...
if(!exists("smart_survey_data")) stop("Dataframe called smart_survey_data not available. This should be in the function enviroment of render_main_site. Check that this is available in this enviroment.")

grade_freqs <- data.frame(table(smart_survey_data$grade))
...
carsurvey2::html_insert_table_toggle("dep-freqs")
...
grades <- data.frame(table(smart_survey_data$grade))
