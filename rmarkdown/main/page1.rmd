...
plot <- carsurvey2::plot_freqs(tables$first_learnt, xlab = "First coding experience", ylab = "Count", n = samples$any_code_experience, break_q_names_col = "First coding experience", orientation = "h", font_size = 14, width = 600)
